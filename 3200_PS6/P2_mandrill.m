%Use SVD to create rank N approximations for the mandrill image.  Note to
%graders: I commented out the imwrite calls so that you don't get a bunch
%of junk images on your machine if you run the codes :)
%@Author: Dan Ruley
%@Date: May, 2020
close all;
...
%imwrite(X,gray,"mandrill_true.jpg");
...
for i = 1:length(ranks)
    ...
    %imwrite(Xk,gray,strcat('Mandrill_rank',num2str(ranks(i)),'.jpg'));
